        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            ...
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-300">We are open to here your ideas. Don't hesitate to
                        contact us anytime our team is ready to respond to your inquiry.</p>
            ...
            <form action="{{ route('contact.store')}}" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
                ...
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit"
                            class="rounded-md bg-amber-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">Send
                            message</button>
                    </div>
                </div>
            </form>
