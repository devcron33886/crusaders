...
return [
    ...
    */
    ...
    |
    */
    'dont_report' => [Enlightn\Enlightn\Analyzers\Performance\QueueDriverAnalyzer::class, Enlightn\Enlightn\Analyzers\Performance\UnusedGlobalMiddlewareAnalyzer::class, Enlightn\Enlightn\Analyzers\Reliability\CustomErrorPageAnalyzer::class, Enlightn\Enlightn\Analyzers\Reliability\EnvVariableAnalyzer::class, Enlightn\Enlightn\Analyzers\Security\FilePermissionsAnalyzer::class, Enlightn\Enlightn\Analyzers\Security\PHPIniAnalyzer::class, Enlightn\Enlightn\Analyzers\Security\StableDependencyAnalyzer::class, Enlightn\Enlightn\Analyzers\Security\XSSAnalyzer::class],
    ...
    |
    */
    'ignore_errors' => [Enlightn\Enlightn\Analyzers\Reliability\DeprecatedCodeAnalyzer::class => [['path' => 'app/Http/Requests/Auth/LoginRequest.php', 'details' => 'Return type of method App\\Http\\Requests\\Auth\\LoginRequest::rules() has typehint with deprecated interface Illuminate\\Contracts\\Validation\\Rule:
see ValidationRule'], ['path' => 'app/Http/Requests/ProfileUpdateRequest.php', 'details' => 'Return type of method App\\Http\\Requests\\ProfileUpdateRequest::rules() has typehint with deprecated interface Illuminate\\Contracts\\Validation\\Rule:
see ValidationRule']], Enlightn\Enlightn\Analyzers\Reliability\InvalidMethodCallAnalyzer::class => [['path' => 'app/Models/Profile.php', 'details' => 'Call to an undefined method Spatie\\Image\\Manipulations::nonQueued().']], Enlightn\Enlightn\Analyzers\Security\UnguardedModelsAnalyzer::class => [['path' => 'app/Providers/AppServiceProvider.php', 'details' => 'Static method unguard detected on class Illuminate\\Database\\Eloquent\\Model.']]],
